...
public class chooseFighter extends JLabel{
	...
	public chooseFighter(JFrame jf){
		...
		ImageIcon nameB= new ImageIcon(Toolkit.getDefaultToolkit().getImage("name.png").getScaledInstance((int)(jf.getWidth()*0.450), (int)(jf.getHeight()*0.230), java.awt.Image.SCALE_SMOOTH));
		
		JLabel name=new JLabel(nameB);
		add(name);
		//name.setBounds(650, 250, 670,200);
		name.setBounds((int)(jf.getWidth()*0.48), (int)(jf.getHeight()*0.30), (int)(jf.getWidth()*0.45), (int)(jf.getHeight()*0.23));
...
//		pick.setBounds(490, 50, 950,250);
	...
	//	pick.setBorderPainted(false);
		...
		add(txt);
		txt.setVisible(true);
		//txt.setBounds(750, 400, 450,50);
		txt.setBounds((int)(jf.getWidth()*0.540), (int)(jf.getHeight()*0.49), (int)(jf.getWidth()*0.30), (int)(jf.getHeight()*0.10));
		
		txt.setFont(new Font(Font.SANS_SERIF, Font.CENTER_BASELINE, 40));
		...
		ImageIcon nameBlock= new ImageIcon(Toolkit.getDefaultToolkit().getImage("nametxtblock.png").getScaledInstance((int)(jf.getWidth()*0.36), (int)(jf.getHeight()*0.15), java.awt.Image.SCALE_SMOOTH));
		
		JLabel txtback=new JLabel(nameBlock);
		add(txtback);
		//txtback.setBounds(720, 380, 520,110);
		txtback.setBounds((int)(jf.getWidth()*0.525), (int)(jf.getHeight()*0.47), (int)(jf.getWidth()*0.36), (int)(jf.getHeight()*0.15));
